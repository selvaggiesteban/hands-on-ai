...
- âŒ Wrong: `<div>Text here</div>` - **Text will NOT appear in PowerPoint**
- âŒ Wrong: `<span>Text</span>` - **Text will NOT appear in PowerPoint**
...
- âŒ Wrong: `'Segoe UI'`, `'SF Pro'`, `'Roboto'`, custom fonts - **Might cause rendering issues**
...
- âŒ Wrong: `color: "#FF0000"` (breaks document)
